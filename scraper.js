var web3 = require('web3')
	...
	,fs = require('fs')
	,rates = {}
	,contractCode = fs.readFileSync('app/contracts/OpenStore.sol','utf8')

web3.setProvider(new web3.providers.HttpProvider('http://localhost:8101'));
var account = web3.eth.defaultAccount = web3.eth.accounts[0]

var compiled = web3.eth.compile.solidity(contractCode)
	,OpenStore = web3.eth.contract(compiled.OpenStore.info.abiDefinition).at("0xb4934dc0e40fb0a40d1b844d95abc1d426c54802")
...
request('https://coinmarketcap-nexuist.rhcloud.com/api/eth',function(error,response,body){
	...
	for(currency in rates){
		...
		var newRate = rates[currency]
			...
			,rateBytes = OpenStore.getValue(account,currency)
		...
		if(
			...
			|| rate.equals(0) && newRate.notEqualTo(0)
				...
				OpenStore.set(currency,newRateRounded)
		}
	}
